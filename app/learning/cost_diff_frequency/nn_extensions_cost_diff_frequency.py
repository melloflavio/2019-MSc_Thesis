...
class NnExtensionCostDiffFrequency():
...
class ActorCostDiffFrequency(NnExtensionCostDiffFrequency, Actor):
  pass

class CriticCostDiffFrequency(NnExtensionCostDiffFrequency, Critic):
  pass
